...
const envSchema = z.object({
  ...
  PASSWORD_SETUP_REQUEST_MAX_ATTEMPTS: z.coerce.number().int().min(1).max(1000).default(5),
  PASSWORD_SETUP_COMPLETE_MAX_ATTEMPTS: z.coerce.number().int().min(1).max(1000).default(10),
